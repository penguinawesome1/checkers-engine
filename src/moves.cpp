...
void Moves::decodeMoveSquares(const Checkers::MoveCords &move,
...
Checkers::PieceName Moves::getBoardName(const Checkers::Pieces &pieces,
...
Checkers::Bitboard &Moves::getBoard(Checkers::Pieces &pieces,
...
void Moves::tryToDeleteCapture(Checkers::Pieces &pieces,
...
void Moves::tryToMove(Checkers::Pieces &pieces, Checkers::MoveData &moveData,
...
void Moves::tryToPromote(Checkers::Pieces &pieces, Checkers::MoveData &moveData,
                         const Checkers::Bitboard endSquare) const {
  using namespace Checkers;
...
void Moves::addMoves(std::vector<Checkers::MoveCords> &allMoves,
...
void Moves::doMove(const Checkers::MoveCords move, Checkers::Pieces &pieces,
...
void Moves::undoMove(Checkers::Pieces &pieces) {
  using namespace Checkers;
...
std::vector<Checkers::MoveCords>
Moves::possibleMoves(const Checkers::Pieces &pieces,
  ...
  std::vector<Checkers::MoveCords> allMoves;
  ...
  if (isWhiteTurn) {
    ...
    addMoves(allMoves, pieces.whiteKings, occupied, RIGHT_BACK, -1, -1, ~COL_1,
             ~ROW_8);
  } else {
    ...
    addMoves(allMoves, pieces.blackKings, occupied, RIGHT_BACK, -1, -1, ~COL_1,
             ~ROW_8);
  }
